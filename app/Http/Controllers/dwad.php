...
if ($jawaban == "1") {
	...
	if ($ddd == '0') {
		...
		header("location:Diagnosis_hasil.php?id=$id_user");
	} else {
		header("location:Diagnosis_mulai.php?id=$id_user&gejala=$gejala_selanjutnya");
	}
} else if ($jawaban == "0") {
	...
	if ($bb > 0) {
		...
		// echo "hasil tidak di temukan atau kulit anda baik-baik saja";
		header("location:Diagnosis_hasil.php?id=$id_user");
	}
}
